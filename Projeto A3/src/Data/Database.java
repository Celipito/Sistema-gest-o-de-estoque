...
public class Database {
   ...
   public static void connection() throws SQLException {
      try {
         ...
         dbconn = DriverManager.getConnection("jdbc:mysql://localhost:3306/cadalunobase", "root", "admin");
         System.out.println("Conectado ao banco de dados com sucesso em: jdbc:mysql://localhost:3306/cadalunobase");
